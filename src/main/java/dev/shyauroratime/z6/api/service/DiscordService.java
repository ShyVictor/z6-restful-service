...
public class DiscordService {
    ...
    public void logTransactionToDiscord(String userAccount, double amount, String transactionType) {
        ...
        requestBody.put("content", "[**Z6 BANK** <:finalizar:967223750858788915>] A conta de ID "+userAccount+"realizou uma transação do tipo **"+transactionType+"**. " +
                "Seu valor foi de:"+amount+".");
